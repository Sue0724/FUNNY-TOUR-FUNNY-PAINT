// pages/map_canvas/map_canvas.js
Page({
  ...
  async onLoad(options) {
    ...
    this.setData({
      markers: markers,
      chosenFixedLongitude: options.fixedLng,
      chosenFixedLatitude: options.fixedLat,
      latitude: options.fixedLat,
      longitude: options.fixedLng
    });
