// pages/map_choose_places/map_choose_places.js
const app = getApp();
...
Page({
  ...
  navigateToDrawMode() {
    ...
    const fixedLat = this.data.chosenFixedLatitude;
    const fixedLng = this.data.chosenFixedLongitude;
    wx.navigateTo({
      url: `/pages/map_canvas/map_canvas?markers=${encodeURIComponent(markers)}&fixedLat=${fixedLat}&fixedLng=${fixedLng}`
    });
  },
